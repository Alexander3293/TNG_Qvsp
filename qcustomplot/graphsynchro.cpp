#include "graphsynchro.h"
#include "ui_graphsynchro.h"

graphsynchro::graphsynchro(SyncModuleTranciever* transceiver, QWidget *parent) :
    QWidget(parent),
    ui(new Ui::graphsynchro)
{
    ui->setupUi(this);
...
graphsynchro::~graphsynchro()
{
    delete ui;
}

void graphsynchro::setWidth(int val)
{
//    width_ = val;
//   // y.resize(width_);
...
void graphsynchro::initGraphSync()
{
...
void graphsynchro::frstPlotData(SyncModuleTranciever::pointsFromSync *dataPckt)
{
...
void graphsynchro::plotData(SyncModuleTranciever::pointsFromSync *dataPckt)
{
...
/* задать смещение */
void graphsynchro::setOffset(uint8_t numPckt,uint8_t numMeasure, const int blk_cnt)
{
//    if(blk_cnt == 1){
//        numPckt_ = numPckt;
...
void graphsynchro::changeTimeBreakSlot(const QString cmd, const QString chnl)
{
//    Q_UNUSED(cmd);
